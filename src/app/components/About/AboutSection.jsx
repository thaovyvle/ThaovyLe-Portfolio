    ...
    return (
        ...
        <div ref={description} className={styles.description}>
            ...
            <div className={styles.textRow}>
                ...
                <motion.p variants={opacity} animate={isInView ? "open" : "closed"}>Currently seeking opportunities as a Software Developer and am eager to advance my career in this dynamic industry.</motion.p>
            </div>
            </div>
        </div>
        </section>
