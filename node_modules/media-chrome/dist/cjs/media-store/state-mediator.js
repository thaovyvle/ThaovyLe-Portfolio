...
const StreamTypeValues = (
  ...
  Object.values(import_constants.StreamTypes)
);
let volumeSupported;
const volumeSupportPromise = (0, import_platform_tests.hasVolumeSupportAsync)().then(
  (supported) => {
...
const stateMediator = {
  ...
  mediaBuffered: {
    get(stateOwners) {
      ...
      const timeRanges = (
        /** @type {TimeRanges} */
        (_a = media == null ? void 0 : media.buffered) != null ? _a : []
      );
      return Array.from(
        /** @type {ArrayLike<any>} */
        /** @type unknown */
