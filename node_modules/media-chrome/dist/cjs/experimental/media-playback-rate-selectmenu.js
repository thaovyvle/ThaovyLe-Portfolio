...
__export(media_playback_rate_selectmenu_exports, {
  MediaPlaybackRateSelectMenu: () => MediaPlaybackRateSelectMenu,
...
class MediaPlaybackRateSelectMenu extends import_media_chrome_selectmenu.MediaChromeSelectMenu {
  init() {
    const playbackRateButton = import_server_safe_globals.document.createElement(
      "media-playback-rate-button"
    );
    playbackRateButton.part.add("button");
    playbackRateButton.preventClick = true;
    const playbackRateListbox = import_server_safe_globals.document.createElement(
