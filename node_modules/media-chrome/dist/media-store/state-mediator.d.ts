...
export function prepareStateOwners(...stateOwners: (StateOwners[keyof StateOwners])[]): Promise<void>;
/** @type {StateMediator} */
...
export type AvailabilityTypeValue = {
...
export type StateOption = {
    ...
    defaultStreamType?: StreamTypeValue;
 ...
 * <D>
 */
export type EventOrAction<D extends unknown = undefined> = {
    type: Event['type'];
    detail?: D;
    target?: Event['target'];
};
 ...
 * <T>
 */
export type FacadeGetter<T, D extends unknown = T> = (stateOwners: StateOwners, event?: EventOrAction<D>) => T;
/**
 * <T>
 */
 ...
 * <T>
 */
export type ReadonlyFacadeProp<T, D extends unknown = T> = {
 ...
 * <T,S,D>
 */
export type FacadeProp<T, S extends unknown = T, D extends unknown = T> = ReadonlyFacadeProp<T, D> & {
    set: FacadeSetter<S>;
};
/**
 *
